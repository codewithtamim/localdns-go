...
```
main/           JNI entry points and exported C API
infra/android/  Bridge between JNI callbacks and Go session layer
app/session/    VPN session lifecycle (DoH/DoT)
proxy/          DoH and DoT clients
transport/      TUN stack, TCP/UDP forwarding
core/           DNS relay engine
```
